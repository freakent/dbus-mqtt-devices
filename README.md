...
cd /data/drivers
wget -O dbus-mqtt-devices.zip https://github.com/freakent/dbus-mqtt-devices/archive/refs/tags/v0.6.4-rc1.zip
...
```
./dbus-mqtt-devices-0.6.4-rc1/bin/setup.sh
```
...
```
cat /data/rc.local
ln -s /data/drivers/dbus-mqtt-devices-0.6.4-rc1/bin/service /service/dbus-mqtt-devices
```
